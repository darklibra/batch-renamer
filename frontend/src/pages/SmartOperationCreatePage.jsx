  ...
  const validateStep = (stepIndex) => {
    switch (stepIndex) {
      ...
      case 3: // Preview & Confirm
        return preview !== null && preview.warnings.length === 0;
      default:
        return false;
    }
  };
    ...
    <Card>
      <CardContent sx={{ p: 3 }}>
        ...
        <TextField
          ...
          placeholder="e.g., {year}-{month}-{day}_{original_name}"
          value={formData.target_template}
          onChange={(e) => handleInputChange('target_template', e.target.value)}
          required
          helperText="Use {field_name} placeholders from the selected pattern"
        />
        ...
        <Button
          ...
          disabled={!formData.source_pattern_id || !formData.target_directory || !formData.target_template}
          sx={{ mt: 2 }}
        >
          Generate Preview
        </Button>
